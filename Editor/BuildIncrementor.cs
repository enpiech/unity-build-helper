namespace BuildHelper.Editor
{
    ...
    public class BuildIncrementor : IPreprocessBuildWithReport
    {
        ...
        private const string BUILD_ASSET_PATH = "Assets/Resources/Build.asset";
        ...
        public void OnPreprocessBuild(BuildReport report)
        {
            ...
            switch (report.summary.platform)
            {
                ...
                case BuildTarget.WSAPlayer:
                    PlayerSettings.WSA.packageVersion = new System.Version(PlayerSettings.WSA.packageVersion.Major,
            ...
            AssetDatabase.DeleteAsset(BUILD_ASSET_PATH); // delete any old build.asset
            AssetDatabase.CreateAsset(buildScriptableObject, BUILD_ASSET_PATH); // create the new one with correct build number before build starts
